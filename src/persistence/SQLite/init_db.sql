...
FOREIGN KEY (FRM_ID) REFERENCES T_FORM_FRM(FRM_ID) ON UPDATE CASCADE ON DELETE CASCADE
);
...
FOREIGN KEY (QST_ID) REFERENCES T_QUESTION_QST(QST_ID) ON UPDATE CASCADE ON DELETE CASCADE
);
...
FOREIGN KEY (SBJ_ID) REFERENCES T_SUBJECT_SBJ(SBJ_ID) ON UPDATE CASCADE ON DELETE CASCADE,
FOREIGN KEY (QST_ID) REFERENCES T_QUESTION_QST(QST_ID) ON UPDATE CASCADE ON DELETE CASCADE
);
...
FOREIGN KEY (SBJ_ID) REFERENCES T_SUBJECT_SBJ(SBJ_ID) ON UPDATE CASCADE ON DELETE CASCADE,
FOREIGN KEY (CHC_ID) REFERENCES T_CHOICE_CHC(CHC_ID) ON UPDATE CASCADE ON DELETE CASCADE
);
...
FOREIGN KEY (ID_SUBSTITUENT_TERM) REFERENCES SUBSITUENT_TERM(ID_SUBSTITUENT_TERM) ON UPDATE CASCADE ON DELETE CASCADE
);
